...
Int_t  main(int argc, char *argv[]){ 
  ...
  if ( argc == 1 ) {
    printf( "No arguments passed. You have to pass 2 arguments: Level0_filename and tle_filename. A third argument is optional: cpu_time_offset to be added to gtu_time and timestamp_unix\n" ); 
  }
  else {
